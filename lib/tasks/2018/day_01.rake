...
namespace :'2018' do
  ...
  task :day01 do
    result = Advent2018::Day01.all Advent2018::Day01.load_file
    puts "Day 01 Answers\n" \
  ...
  namespace :day01 do
    ...
    task :part1 do
      result = Advent2018::Day01.part_1 Advent2018::Day01.load_file
      puts "Day 01 part 1: #{result}"
    end

    desc 'Run day 01 part 2'
    task :part2 do
      result = Advent2018::Day01.part_2 Advent2018::Day01.load_file
      puts "Day 01 part 2: #{result}"
    end
  end
end

module Advent2018::Day01
  def self.load_file
    data = []
